...
# Database: xiaolu
# Generation Time: 2018-05-31 06:13:42 +0000
# ************************************************************
...
VALUES
	...
	(3,'com.test','com.test',2,'xiaomi',1527645963,1527645963,1),
...
VALUES
	...
	(2,1,'test',1,2,'插屏广告22','test','test444',0),
	(4,1,'test',3,1,'视频广告','tst123456','test444',0),
	(5,2,'test333',3,2,'插屏广告22','tst123456','test5555',0);
...
INSERT INTO `xl_position` (`id`, `title`, `status`)
VALUES
	(1,'视频广告',1),
	(2,'插屏广告22',1);
